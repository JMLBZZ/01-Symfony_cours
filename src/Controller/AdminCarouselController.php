...
class AdminCarouselController extends AbstractController
{
    ...
    public function new(Request $request, CarouselRepository $carouselRepository): Response
    {
        ...
        $form->handleRequest($request);//hydrater = remplir / on va chercher à remplir le formulaire (l'entité) avec les données qui se trouve potentiellement dans la requete
        //dd($form->getData());
